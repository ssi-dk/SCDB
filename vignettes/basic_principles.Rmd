...
options(warn=-1) # at least until get_connection does not give a warning on a new sqlite connection
```
...
Note: This strategy of time versioning is often called "type 2" historics.
